...
public class PythonQuantumCodegen extends AbstractPythonConnexionServerCodegen {
    private final Logger LOGGER = LoggerFactory.getLogger(PythonQuantumCodegen.class);

    public PythonQuantumCodegen() {
        super("python-quantum", false);
    }
